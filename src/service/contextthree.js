...
const BASE_MOVIE_URL =`https://api.themoviedb.org/3/movie/upcoming?api_key=${API_KEY}&include_video=false&language=en-US&page=9&sort_by=popularity.desc`;
...
export default fetchMovieThree